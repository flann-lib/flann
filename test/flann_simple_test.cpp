...
TEST_F(Flann_SIFT10K_Test, KDTreeTestIncremental2)
{
    size_t size1 = data.rows/2+1;
    size_t size2 = data.rows-size1;
    Matrix<float> data1(data[0], size1, data.cols);
...
TEST_F(Flann_SIFT10K_Test, KMeansTreeIncremental2)
{
    size_t size1 = data.rows/2+1;
    size_t size2 = data.rows-size1;
    Matrix<float> data1(data[0], size1, data.cols);
...
TEST_F(Flann_SIFT100K_Test, KMeansTreeIncremental2)
{
    size_t size1 = data.rows/2+1;
    size_t size2 = data.rows-size1;
    Matrix<float> data1(data[0], size1, data.cols);
...
TEST_F(Flann_Brief100K_Test, HierarchicalClusteringTestIncremental2)
{
    size_t size1 = data.rows/2+1;
    size_t size2 = data.rows-size1;
    Matrix<ElementType> data1(data[0], size1, data.cols);
...
TEST_F(Flann_Brief100K_Test, LshTestIncremental)
{
    size_t size1 = data.rows/2-1;
    size_t size2 = data.rows-size1;
    Matrix<ElementType> data1(data[0], size1, data.cols);
...
TEST_F(Flann_Brief100K_Test, LshTestIncremental2)
{
    size_t size1 = data.rows/2+1;
    size_t size2 = data.rows-size1;
    Matrix<ElementType> data1(data[0], size1, data.cols);
